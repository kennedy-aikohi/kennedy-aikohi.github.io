...
- Queries Win32\_Process by ProcessId
...
rule ShinySp1d3r\_Go\_Ransomware
...
malware\_family = "ShinySp1d3r"

confidence = "High"

strings:

$go\_runtime1 = "runtime.goexit" ascii

$go\_runtime2 = "GOMAXPROCS" ascii

$wmi1 = "winmgmts:\\\\.\\root\\cimv2" ascii

$wmi2 = "Win32\_Process" ascii
...
(Query="\*Win32\_Process\*" OR Query="\*ProcessId\*")
...
and winlog.event\_data.Namespace : "root\\cimv2"

and winlog.event\_data.Query : ("\*Win32\_Process\*" or "\*ProcessId\*")
